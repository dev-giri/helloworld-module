...
@section('vendor-style')
  <!-- vendor css files -->
  <link rel="stylesheet" href="{{ asset('themes/girisoft/vendors/css/editors/quill/katex.min.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/girisoft/vendors/css/editors/quill/monokai-sublime.min.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/girisoft/vendors/css/editors/quill/quill.snow.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/girisoft/vendors/css/extensions/toastr.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('themes/girisoft/vendors/css/extensions/dragula.min.css') }}">
@endsection

@section('page-style')
<!-- Page css files -->
  <link rel="stylesheet" href="{{ asset('themes/girisoft/css/base/plugins/forms/form-quill-editor.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/girisoft/css/base/plugins/forms/pickers/form-flat-pickr.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/girisoft/css/base/plugins/extensions/ext-component-toastr.css') }}">
...
<div class="todo-app-list">
  ...
  <div class="todo-task-list-wrapper list-group">
    <ul class="todo-task-list media-list" id="todo-task-list">
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-4.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-5.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item completed" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          <div class="todo-title-area">
            <i data-feather="more-vertical" class="drag-icon"></i>
            <div class="title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-8.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-11.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-7.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-17.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
      ...
      <li class="todo-item" data-toggle="modal" data-target="#new-task-modal">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-2.jpg') }}"
                alt="user-avatar"
                height="32"
                width="32"
              />
...
<div class="modal modal-slide-in sidebar-todo-modal fade" id="new-task-modal" role="dialog">
          ...
          <div class="action-tags">
            ...
            <div class="form-group position-relative">
              ...
              <select class="select2 form-control" id="task-assigned" name="task-assigned">
                <option
                  data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-3.jpg') }}"
                  value="Phill Buffer"
                  selected
                >
                  Phill Buffer
                </option>
                <option data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-1.jpg') }}" value="Chandler Bing">
                  Chandler Bing
                </option>
                <option data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-4.jpg') }}" value="Ross Geller">
                  Ross Geller
                </option>
                <option data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-6.jpg') }}" value="Monica Geller">
                  Monica Geller
                </option>
                <option data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-2.jpg') }}" value="Joey Tribbiani">
                  Joey Tribbiani
                </option>
                <option data-img="{{ asset('themes/girisoft/images/portrait/small/avatar-s-11.jpg') }}" value="Rachel Green">
                  Rachel Green
                </option>
              </select>
            </div>
...
<!-- vendor js files -->
  <script src="{{ asset('themes/girisoft/vendors/js/editors/quill/katex.min.js') }}"></script>
  <script src="{{ asset('themes/girisoft/vendors/js/editors/quill/highlight.min.js') }}"></script>
  <script src="{{ asset('themes/girisoft/vendors/js/editors/quill/quill.min.js') }}"></script>
  ...
  <script src="{{ asset('themes/girisoft/vendors/js/extensions/dragula.min.js') }}"></script>
  <script src="{{ asset('themes/girisoft/vendors/js/forms/validation/jquery.validate.min.js') }}"></script>
  <script src="{{ asset('themes/girisoft/vendors/js/extensions/toastr.min.js') }}"></script>
@endsection
